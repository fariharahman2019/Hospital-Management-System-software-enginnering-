	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='add-outbreak.php'><img class='sidebar-menu-icon' src='images/ic_group_work_white_24dp.png'  /> Add Emergency</a></li>
				<li><a href='outbreaks.php'><img class='sidebar-menu-icon' src='images/ic_group_work_white_24dp.png'  /> Emergency</a></li>
				<li><a href='hiv.php'><img class='sidebar-menu-icon' src='images/ic_error_outline_white_24dp.png'  /> Report</a></li>
				<li><a href='reports.php'><img class='sidebar-menu-icon' src='images/ic_receipt_white_24dp.png'  /> All Reports</a></li>
			</ul> 
		</div> 
	</div>
	<?php 
